...
def about():
    ...
    This program is a creative assignment by Kevin Chen and ______ , created in COSI 103, Spring 2023 <br>
...
def index2():
    ...
    <ul>
      ...
      <li><a href="/team/member_2">Member 2</a></li>
